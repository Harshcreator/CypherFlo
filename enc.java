...
class Home implements ActionListener {
        ...
        Home()
        {
            ...
            Font f1 = new Font("Roboto Mono", Font.BOLD, 35);
            Font f2 = new Font("Roboto Mono" + "", Font.BOLD, 20);
            ...
            btn3 = new JButton("Image Ciphering");
            btn3.addActionListener(this);
            btn3.setBounds(155, 370, 190, 50);
            btn3.setFont(f2);
            frame.add(btn3);
...
class Encryption implements ActionListener,ItemListener
{
    ...
    Color consoleBg= Color.decode("#0F0064");
    ...
    Font titleFont=new Font("Roboto Mono",Font.BOLD,28);
